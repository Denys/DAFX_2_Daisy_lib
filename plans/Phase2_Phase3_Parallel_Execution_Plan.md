...
| # | Effect | Phase | Complexity | MATLAB Source |
|---|--------|-------|------------|---------------|
| 1 | YIN Pitch Detection | 2 | High | yinDAFX.m |
| 2 | Compressor/Expander | 2 | Medium | compexp.m |
| 3 | Universal Comb Filter | 2 | Low | unicomb.m |
| 4 | LP-IIR Comb Filter | 3 | Medium | lpiircomb.m |
| 5 | FDN Reverb | 2 | High | delaynetwork.m |
| 6 | SOLA Time Stretch | 2 | High | TimeScaleSOLA.m |
...
| # | Effect | Phase | Complexity | MATLAB Source |
|---|--------|-------|------------|---------------|
| 1 | Robotization | 2 | Medium | VX_robot.m |
| 2 | Whisperization | 2 | Medium | VX_whisper.m |
| 3 | Spectral Filtering | 3 | High | VX_filter.m |
| 4 | Phase Vocoder Pitch | 3 | Very High | VX_pitch_pv.m |
| 5 | Crosstalk Canceller | 3 | Medium | crosstalkcanceler.m |
...
|-----------|----------|---------|----------|
| **FFT Handler** | `src/utility/fft_handler.h` | Robotization, Whisperization, Spectral Filtering, Phase Vocoder, Crosstalk Canceller | CRITICAL |
| **Circular Buffer** | `src/utility/circular_buffer.h` | Universal Comb, LP-IIR Comb, FDN Reverb, SOLA, Vibrato (Phase 1) | CRITICAL |
| **Phase Unwrap** | `src/utility/princarg.h` | Phase Vocoder, Spectral effects | CRITICAL |
| **Window Functions** | `src/utility/windows.h` | All spectral effects, SOLA | HIGH |
| **Cross-Correlation** | `src/utility/xcorr.h` | SOLA Time Stretch | HIGH |
| **Envelope Follower** | `src/utility/envelope.h` | Compressor/Expander, Noise Gate (Phase 1) | MEDIUM |
